      ...
      <div className="p-8 space-y-2">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className="flex items-center space-x-2 bg-green-100 text-green-700 p-2.5 rounded-full">
              <Users className="w-4 h-4" />
              <span className="font-medium text-xs">{car.capacity} seats</span>
            </div>
          ...
          <Link
            href={`/cars/detail/${car.id}`}
            className="px-6 py-2.5 flex items-center space-x-2 font-semibold text-white group bg-gradient-to-r from-indigo-500 to-indigo-800 hover:from-indigo-600 hover:to-indigo-900 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg"
          >
